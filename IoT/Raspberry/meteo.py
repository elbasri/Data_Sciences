class meteo:
    def __init__(self, weather_data):
        ...
        # Assign all weather data to attributes of the class
    ...
    def to_flat_dict(self):
        ...
        # This method will create a flat dictionary with all weather data
        ...
        flat_data = {
            ...
            'visibility': self.data.get('visibility', None),  # Some fields may not be present and need a default value
